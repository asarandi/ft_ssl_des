...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/11/20 14:28:31 by asarandi          #+#    #+#             */
/*   Updated: 2017/11/20 16:41:56 by asarandi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	des3ecb_encrypt_input(t_cmd *opt, t_uc **in, t_uc **out, size_t *sz)
{
...
void	des3ecb_decrypt_input(t_cmd *opt, t_uc **in, t_uc **out, size_t *sz)
{
	unsigned char	pad_byte;
	size_t			new_size;
